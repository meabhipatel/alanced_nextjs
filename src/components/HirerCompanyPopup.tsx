  ...
  return (
    ...
    <div className="fixed inset-0 z-10 mt-10 overflow-y-auto">
      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="relative z-20 w-[90%] rounded-lg bg-white p-6 md:w-[75%] lg:w-[50%]">
          ...
          <div className="mx-4 md:mx-8">
            ...
            {/* Action Buttons */}
            <div className="mt-8 flex flex-col-reverse justify-end gap-3 sm:flex-row sm:justify-end">
              <button
                onClick={handleSave}
                disabled={isUpdating}
