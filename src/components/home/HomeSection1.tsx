    ...
    <div>
      ...
      <div className="flex flex-col gap-4 px-4 md:mt-6 md:flex-row lg:px-32">
        ...
        <div className="w-full p-4 text-left md:w-[50%]">
          ...
          Alanced makes it simple to find freelance jobs online, even for those just starting out. Here, 
        ...
        if you&apos;re a business looking for top talent, Alanced simplifies the freelancer hiring process, connecting you with skilled professionals who can deliver exceptional results.
      </p>
      )}
