      ...
      <div className="mt-10 px-5 lg:px-32">
        ...
        <div className="mt-16 rounded-lg border border-gray-200 border-opacity-50 bg-[#e9e7f9]">
          <div className="flex flex-col-reverse md:flex-row">
            <div className="basis-6/12 p-3 text-left md:mt-8 md:pl-8">
              <div className="text-[25px] font-semibold text-blue-700">
              ...
              <div className="mt-5 text-[30px] font-semibold text-blue-600">
                Take the first step
              </div>
              <div className="text-[30px] font-semibold text-blue-600">
