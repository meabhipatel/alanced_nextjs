    ...
    <div className="lg:px-20s container mt-10 sm:px-5 md:px-10">
      <div className="flex flex-col-reverse rounded-lg border border-gray-200 border-opacity-50 bg-[#dcf7ea] md:flex-row">
        <div className="basis-6/12 p-3 text-left md:mt-8 md:pl-8">
          ...
          <div className="mt-5 text-[35px] font-semibold text-blue-600">Your Trusted</div>
          <div className="text-[28px] font-semibold text-blue-600">Partner For Design And</div>
          <div className="text-[28px] font-semibold text-blue-600">Web Development.</div>
          <div className="mt-8 text-[16px] font-normal opacity-50">
      ...
      <div>
        <div className="flex justify-center">
          <div className="mt-5 text-[30px] font-semibold">Key Features</div>
        </div>
        ...
        <div className="mt-10 flex flex-col gap-2 md:flex-row">
          <div className="basis-3/12 rounded-lg border border-blue-200 border-opacity-50 bg-[#daf6f8] p-3 shadow-md">
            ...
            <div className="mt-2 text-left text-[26px]">Talent</div>
            <h1 className="mt-3 text-left text-[18px]">
          ...
          <div className="basis-3/12 rounded-lg border border-blue-200 border-opacity-50 bg-[#e6ebfc] p-3 shadow-md">
            ...
            <div className="mt-2 text-left text-[26px]">Security</div>
          ...
          <div className="basis-3/12 rounded-lg border border-blue-200 border-opacity-50 bg-[#e3f7e9] p-3 shadow-md">
            ...
            <div className="mt-2 text-left text-[26px]">Work</div>
            <p className="mt-3 text-left text-[18px]">
          ...
          <div className="basis-3/12 rounded-lg border border-blue-200 border-opacity-50 bg-[#f5f5f4] p-3 shadow-md">
            ...
            <div className="mt-2 text-left text-[26px]">Centralized Hub</div>
            <p className="mt-3 text-left text-[18px]">
      ...
      <div className="mt-8 flex flex-col rounded-lg border border-gray-200 border-opacity-50 md:mt-16 md:flex-row">
        ...
        <div className="basis-6/12 p-3 text-left md:mt-8 md:pl-8">
          <div className="text-[30px] font-semibold">How It Works</div>
          <div className="relative mt-1 w-20">
            <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#0909E9] to-[#00D4FF]"></div>
            <div className="rounded-lg border-b-2 border-gray-600"></div>
          </div>
          <div className="mt-5 text-[25px] font-semibold">Client</div>
          ...
          <div className="mt-4 text-[25px] font-semibold">System</div>
          <p className="mt-4 text-[16px] font-normal opacity-50">
            The system processes the entered data, performs necessary calculations or checks, and
            stores the results.
          </p>
          <div className="mt-4 text-[25px] font-semibold">Output</div>
          <p className="mt-4 text-[16px] font-normal opacity-50">
            The system provides feedback to the client through the web-based user interface, showing
      ...
      <div className="mt-16 rounded-lg border border-gray-200 border-opacity-50 bg-[#e9e7f9]">
        <div className="flex flex-col-reverse md:flex-row">
          <div className="basis-6/12 p-3 text-left md:mt-8 md:pl-8">
            <div className="text-[25px] font-semibold text-blue-700">What are you waiting for?</div>
            <div className="relative mt-1 w-20">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#0909E9] to-[#00D4FF]"></div>
              <div className="rounded-lg border-b-2 border-gray-600"></div>
            </div>
            <div className="mt-5 text-[30px] font-semibold text-blue-600">Take the first step</div>
            <div className="text-[30px] font-semibold text-blue-600">towards a brighter future</div>
