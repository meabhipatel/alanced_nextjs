    ...
    <div className="mx-[5%] mt-20 lg:mx-[2%] xl:mx-0">
      <div className="my-2 border border-gray-200 border-opacity-30 bg-[#FFFFFF] px-6 py-5 text-left sm:px-8 lg:px-12 xl:px-16">
        ...
        <p className="text-sm leading-relaxed sm:text-base lg:text-lg">
          Welcome to Alanced! Please take a moment to review our Terms &amp; Conditions. By
          continuing to use our platform, you agree to comply with these guidelines, which outline
          your rights and responsibilities while using our website and services
        </p>
        ...
        <ul className="mt-2 list-inside list-disc space-y-2">
          ...
          <li>
            You are accountable for keeping your account credentials secure and for all actions
            taken under your account
          </li>
          <li>
            You commit to adhering to all relevant laws and regulations while utilizing our
            platform.{" "}
          </li>
        </ul>
        ...
        <ul className="mt-2 list-inside list-disc space-y-2">
          <li>
            The materials found on Alanced, such as logos, trademarks, and other proprietary
            content, are either owned by Alanced or licensed for its use.
          </li>
          <li>
            You acknowledge that you will not use, replicate, distribute, or develop derivative
            works from our intellectual property without obtaining prior written permission.
          </li>
        </ul>
