  ...
  return (
    <Fragment>
      <div className="container mt-20 sm:px-5 md:px-10 lg:px-20">
        ...
        <p>
          At Alanced, we utilize cookies to enrich your experience and optimize our platform&apos;s
          functionality. This Cookie Policy outlines how we employ cookies and related technologies
        ...
        <ul className="ml-4 list-inside list-disc">
          ...
          <li>
            ...
            advertisements tailored to your interests, taking into account your browsing activities
            and preferences.
          </li>
          <li>
        ...
        <p>
          If you have any inquiries or concerns regarding our Cookie Policy or our practices related
          to cookies, please reach out to us at{" "}
          <a
