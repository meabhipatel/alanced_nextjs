...
const SignupOptions = () => {
  ...
  return (
    <div className="relative flex h-screen bg-cover bg-center px-5" style={{ backgroundImage: `url(${chooseoption.src})` }}>
      <Link href="/">
      ...
      <div className="flex justify-center items-center w-full h-full">
        <div className="bg-white border border-blue-300 p-6 md:p-8 w-full max-w-md md:max-w-xl mx-auto shadow-lg">
          ...
          <div className="mb-8 flex w-full flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
            ...
            >
              <Image src={client} alt="client" className="mr-4 h-[50px] sm:-mt-3 sm:mr-0" />
              <h5 className="font-cardo text-left text-[16px] lg:py-1">I’m A Client, Hiring For A Project</h5>
            </button>
            <button
              className={`flex w-full items-center border-2 p-6 sm:block sm:flex-1 ${
            ...
            >
              <Image src={freelancer} alt="freelancer" className="mr-4 h-[50px] sm:-mt-3 sm:mr-0" />
              <h5 className="font-cardo text-left text-[16px] lg:py-1">I’m A Freelancer, Looking For Work</h5>
            </button>
          </div>
          ...
          <div className="flex flex-col items-center">
            {selectedOption === "freelancer" ? (
              <Link href="/signup/freelancer">
                <button className="focus:shadow-outline-blue -mt-2 block w-[320px] rounded-lg border border-none bg-gradient-to-r from-[#0909E9] to-[#00D4FF] hover:from-[#00D4FF] hover:to-[#0909E9] px-4 py-2 text-center text-sm font-semibold leading-5 text-white transition-colors duration-150 focus:outline-none">
            ...
            <p className="font-inter pt-2.5 text-xs text-center">
